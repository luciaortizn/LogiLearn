...
class EmptyEditableCardViewModel :ViewModel() {
    ...
    private final val USER_AGENT = "YourApp/1.2.3"
    private final val CONTENT_TYPE = "application/json"

    fun postTranslation(requestBody: TranslateRequest,callback: TranslationCallback, apiKey:String){
        val call = apiService.translate(AUTHORIZATION + apiKey , USER_AGENT, CONTENT_TYPE, requestBody)
